...
function ControlPanelOptions(props:ControlPanelOptionsProps){
    ...
    {props.optionsList.map((item:string)=><li key={item} onClick={()=>props.selectOption(item as "Gerir colaboradores" | "Gerir tarefas" | "Alterar credenciais")} className="control-panel-options-list-item"><p>{item}</p></li>)}
    </ul>
}
