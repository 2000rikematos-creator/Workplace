 ...
 function ReportListItem(props:FinishedTasksWithData){
    ...
    const totalTime = parseInt(props.timeEnd) - parseInt(props.timeStart)
     return <li className="report-list-item">
        ...
        <p className="finished-tasks-time-end">{timeEnd.getHours()}h{timeEnd.getMinutes()}m{timeEnd.getSeconds()}s | {timeEnd.getDate() < 9 ? "0" + timeEnd.getDate():timeEnd.getDate()}/{timeEnd.getMonth()+1<9? "0"+(timeEnd.getMonth()+1):timeEnd.getMonth()+1}/{timeEnd.getFullYear()}</p>
